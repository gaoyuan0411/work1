drop table if exists dwt__nation__province_stat__d;
create table if not exists dwt__nation__province_stat__d(
...
INSERT OVERWRITE  TABLE dwt__nation__province_stat__d PARTITION (dt,type)
