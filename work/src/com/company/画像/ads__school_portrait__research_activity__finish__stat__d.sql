-- ==================================================================
-- 脚本名称： ads__school_portrait__research_activity__finish__stat__d
-- 所属专题： 学校画像
-- 实现功能： 学校画像--教研活动完成情况
...
--收到活动
   ...
   , yesterday_stat_data AS (
    SELECT stat_date
         ...
         , finish_rate_section
         , stat_time
    FROM ads__school_portrait__research_activity__finish__stat__d a
...
INSERT OVERWRITE TABLE ads__school_portrait__research_activity__finish__stat__d PARTITION (dt = '${biz_date}')
SELECT stat_date
     , period_code
     , period_type_code
     , period_start_date
